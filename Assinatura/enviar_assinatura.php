...
if ($codigo) {
    ...
    echo "<script>alert('Você já está com uma assinatura válida'); </script>" ;
    echo "<script>window.location = 'http://localhost/Ap.Final/PaginaInicialLogada/php/pinilog.php';</script>"; mysqli_error($con);
}

...
if ($seguranca){ 
 ...
 $codigo = mysqli_query($con,"select * from tb_empresa where id_usuario=$codusuario");
 $infobd = 0;
...
$codx= $_POST['codx'];
    ...
    $comando= "select * from tb_empresa where id_usuario='$codx'";
    $resulta = mysqli_query($con, $comando);
    $registro = mysqli_fetch_array($resulta);

    $comando2= "select * from tb_anuncio_empresa where id_usuario='$codx'";
...
<div class=left__col>
  ...
  <img src=../../FotosEmp/".htmlspecialchars($registro[6]).">
  <span></span>
          </div> ";
    ...
    //echo "Codigo:".$registro[0]."<br>";
        echo "<h2>".$registro[2]."</h2>";
        echo "<p>".$registro2[3]."</p>";
        echo "<p>".$registro[3]. "</p>";

...
<script>
 ...
 <form name="form" enctype="multipart/form-data" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
    ...
    <script type="text/javascript">
        ...
        $pesquisa = mysqli_query($con,"select * from tb_empresa ");
        $linha = 0;
        ...
        while($i = mysqli_fetch_array($pesquisa)){
          ...
          echo "<form name='user' action='../../Perfil/php/anunciosemp.php' method=POST>"; 
          ...
          echo "<img class='fotos' src=../../FotosEmp/".$i['ID_LOGOEMP']." width=200 heigth=200 ><br>";
